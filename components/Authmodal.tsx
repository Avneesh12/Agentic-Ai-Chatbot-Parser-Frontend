...
export default function AuthModal({ onSuccess, onClose }: AuthModalProps) {
  ...
  return (
    // Uses .modal-overlay (CSS class) for bottom-sheet on mobile, centered modal on sm+
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        {/* Top accent bar */}
        <div style={{ height: "3px", background: "linear-gradient(90deg, #7c6fff, #a855f7, #06b6d4)" }} />
        ...
        <div style={{ padding: "clamp(20px, 5vw, 28px)" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                <h2 style={{
                  margin: 0, fontSize: "clamp(16px, 4vw, 19px)", fontWeight: 700, color: "white",
          ...
          <div style={{
            ...
            {(["login", "register"] as const).map(tab => (
              <button key={tab} onClick={() => { setMode(tab); setError(""); }} style={{
                flex: 1,
                padding: "11px 0",  // taller for touch
          ...
          <p style={{ textAlign: "center", marginTop: "16px", marginBottom: 0, fontSize: "13px", color: "#6b7280" }}>
            ...
            <button
              ...
              style={{ background: "none", border: "none", cursor: "pointer", color: "#7c6fff", fontWeight: 600, fontSize: "13px", padding: "4px", minHeight: 0 }}
            >
